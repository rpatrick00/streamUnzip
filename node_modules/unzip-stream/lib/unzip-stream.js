...
UnzipStream.prototype.processDataChunk = function (chunk) {
    ...
    switch (this.state) {
        ...
        case states.LOCAL_FILE_HEADER_SUFFIX:
            ...
            // Original emit point for stream.  Commenting this out will break Extract().
            // -rpatrick00
        ...
        case states.CENTRAL_DIRECTORY_FILE_HEADER_SUFFIX:
            ...
            if (entry) {
                // Proposed new emit point.  Uncommenting this will cause Extract to not write any files to disk.
                // - rpatrick00
                // this.emit("entry", entry);
